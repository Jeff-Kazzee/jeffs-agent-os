...
- **Runtime:** Bun (not npm/pnpm/yarn). Use `bun` for all package operations.
- **Framework:** Next.js 15 App Router
- **Port:** 4000
- **Database:** SQLite via better-sqlite3 + Drizzle ORM
- **OS:** Windows 11 — use `where` instead of `which` for binary detection. Use forward slashes in paths.
